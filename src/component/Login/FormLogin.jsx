        ...
        <>
          <form className="text-center mr-auto ml-auto">
            ...
            <div className="flex mt-4 gap-x-2 justify-center">
              <button className="bg-white flex items-center justify-center w-24 h-16 p-2 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-4-blue">
                <svg
              ...
              <button className="bg-white flex items-center justify-center w-24 h-16 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-4-blue">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 32 32"
                  className="w-5 h-5 fill-current"
